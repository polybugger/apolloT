...
public class SQLiteTableNewEditDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = mActivity.getLayoutInflater().inflate(R.layout.fragment_sqlite_table_new_edit_dialog, null);
        ...
        if(mSQLiteRow.getId() != -1) {
            ...
            String colorString = mSQLiteRow.getColor();
            color = TextUtils.isEmpty(colorString) ? (int) Long.parseLong(SQLiteTableActivity.WHITE_COLOR, 16) : (int) Long.parseLong(colorString, 16);
        }
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(data)) {
                    ...
                    try {
                        mSQLiteRow.setData(data);
                        mSQLiteRow.setColor(Integer.toHexString(getColor()));
